...
\kwub{characteristic function} \iMbox{\chi_S : \mathbb{N} \to \{ 0, 1\}} \ =>

\vspace{5.5pt}

given a \stu{subset} \iMbox{S \subseteq \mathbb{N}} its the \stu{function}
\iMbox{\chi_S (x) \triangleq \begin{cases}  1 & x \in S \\ 0 & x \not\in S \end{cases}}
