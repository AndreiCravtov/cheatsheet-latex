...
### Common Predicates returning Booleans
- $\mathrm{isZero} \ \equiv \ \lambda n. \ n \ (\lambda x. \ \mathrm{false}) \ \mathrm{true}$ => $\mathrm{ifZero} \ \equiv \ \lambda nxy. \ n \ (\lambda z. \ y) \ x$
- $(\leq) \ \equiv \ \lambda mn. \ \mathrm{isZero} \ (m - n)$
...
- alternatively: $(+) \ \equiv \ \lambda mnfx. \ mf (nfx)$
...
- alternatively: $(\times) \ \equiv \ \lambda mnf. \ m(nf)$
...
- $\text{fst} \equiv \lambda p. \ p \ \mathrm{K} \equiv \lambda p. \ p \ (\lambda xy.x)$,
- $\mathrm{snd} \equiv \lambda p. \ p \ \mathrm{KI} \equiv \lambda p. \ p \ (\lambda xy.y)$
